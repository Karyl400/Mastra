...
## [0.1.0] - 2026-07-28
### Ajouté
- Initialisation du projet Mastra avec scaffold TypeScript.
- Création des fichiers de règles projet : GEMINI.md, AGENT.md, ANTIGRAVITY.md, CONTEXT.md, TODO.md, CHANGELOG.md.
